...
def user_picture(message):
    ...
    telegram_api='http://api.telegram.org/file/bot611495181:AAHA5zSIi23jcynQ0XmmQ1hDQ0TJNLy3do8/photos/'
...
#OR DOWNLOADING FILE DIRECTLY TO S3 WITHOUT SAVING ON DISK
    ...
    s3 = boto3.resource('s3',
                        aws_access_key_id='AKIAIJGNHBDRWRO7AVFQ',
                        aws_secret_access_key='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')
    bucket_name_to_upload_image_to = 'ec2-18-217-231-222.us-east-2.compute.amazonaws.com'
...
#WRITING INFO INTO SQL TABLE
    host = "regina.cs7a2a9fhowa.us-east-2.rds.amazonaws.com"
    port = 3306
    dbname = "regina"
    user = "regina"
    password = "telegram"
    ...
    cur.execute('create table if not exists pictures_bot_info '
